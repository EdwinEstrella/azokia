...
import { Code2, Database, Cloud, Cpu, Shield, Zap, CheckCircle, Rocket, ArrowRight } from 'lucide-react';
    ...
    <div className="pt-20 bg-[#0D0F2D]">
      ...
      <section className="py-20 bg-gradient-to-br from-[#0D0F2D] via-purple-900 to-indigo-900 relative overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-20 right-10 w-64 h-64 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
        </div>
